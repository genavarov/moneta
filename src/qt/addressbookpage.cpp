    ...
    tab(tab)
{
    ...
    case ReceivingTab:
        ...
        break;
    case ZerocoinTab:
        ui->labelExplanation->setText(tr("These are your private coins from mint zerocoin operation, You can perform spend zerocoin operation to redeem moneta back from Zerocoin."));
        ui->deleteAddress->setVisible(false);
        ui->signMessage->setVisible(false);
...
void AddressBookPage::on_zerocoinSpendButton_clicked(){
    ...
    if(!model->zerocoinSpend()){
        QMessageBox::critical(this, tr("Error"),
            tr("You cannot spend zerocoin !!"),
            QMessageBox::Ok, QMessageBox::Ok);
    }
}
